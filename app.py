...
if uploaded_files:
    ...
    st.download_button(label="Download Combined Excel", data=output, file_name="combined.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")